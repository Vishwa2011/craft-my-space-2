      ...
      {showPopup && (
        ...
        >
          ...
          >
            ...
            >
              <h2 style={{ margin: 0, fontSize: '1.2rem' }}>Manage Consent</h2>
              <button
                onClick={closePopup}
                style={{
                  background: 'none',
            ...
            <a href="#" style={{ color: '#0073e6', textDecoration: 'underline', fontSize: '0.9rem' }}>
              Manage services
            </a>
            ...
            <div style={{ marginTop: '15px', fontSize: '0.85rem' }}>
              <a href="#" style={{ color: '#0073e6', textDecoration: 'underline', marginRight: '10px' }}>Cookie Policy</a>
              <a href="#" style={{ color: '#0073e6', textDecoration: 'underline', marginRight: '10px' }}>Privacy Statement</a>
              <a href="#" style={{ color: '#0073e6', textDecoration: 'underline' }}>Impressum</a>
            </div>
          </div>
        </div>
      )}
...
<div class='TW TWhide' id='TW_box'>
  ...
  <a class='C-button outl' href='#'>Deny</a>
</div>
