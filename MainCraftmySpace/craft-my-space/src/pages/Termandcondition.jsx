        ...
        <div className="page-content">
          ...
          <div className="section-full p-6 md:p-12" style={{ padding: '100px 0px' }}>
            <div className='container mx-auto px-4' style={{textAlign:"justify"}}>
              ...
              >
                 <div>
                   ...
                   <ul style={{lineHeight:'30px'}}>
                    <li>	These terms and conditions form the legally binding agreement between "CRAFTMYSPACE INTERIORS LTD  ” and the person signing the contract/agreeing verbally/placing the order referred to as “the Customer”. The Company Registration Number 15963804. is registered at address is Unit 1, Grange Farm, Grange Way.  IverBuckinghamshire. SL0 9NT        Nothing in this agreement shall affect your statutory rights and it is the Customer’s responsibility to ensure all details are correct. </li>
              ...
              {/* Add more sections as needed with animations */}
            </div>
          </div>
        </div>
        <Footers />
