      ...
      >
        ...
        <div className="page-content">
          <div
            ...
            style={{
              backgroundImage: "url(assets/pic/kitchen-units-black.jpg)",
            }}
          >
                    ...
                    <div className="row justify-content-center">
                      <div className="col-12 col-sm-12 col-md-3 p-3">
                        ...
                        >
                          <div>
                            <img
                              src="/assets/pic/conversation (2).png"
                              alt=""
                            />
                          </div>
                          <div>
                ...
                <div className="col-12">
                  <div className="row">
                    ...
                    >
                      ...
                      <p>
                        At [CraftMySpace], we take pride in crafting
                        high-quality furniture that blends style, durability,
                        and functionality. Our production process is driven by
                        expert craftsmanship, premium materials, and innovative
                        designs to ensure each piece meets the highest
                        standards. From selecting the finest wood and metals to
                        applying precision finishing touches, every step
                        reflects our commitment to excellence. Whether it’s
                        modern, classic, or custom-made furniture, we create
                        pieces that enhance comfort and aesthetics, making every
                        space truly exceptional.We believe that furniture is
                        more than just a functional necessity—it’s an expression
                        of style and comfort. That’s why we pay meticulous
                        attention to design, structure, and finishing, ensuring
                        that our products enhance both residential and
                        commercial spaces. Our team continuously innovates,
                        keeping up with the latest trends while maintaining
                        timeless craftsmanship that stands the test of time.
                      </p>
                    </div>
                          ...
                          >
                            <div className="wt-post-media wt-img-effect zoom-slow relative">
                              <a className="block relative">
                                <img
                                  src="/assets/pic/INSPIRATION1.webp"
                                  alt=""
                                />
                              </a>
                            </div>
