            ...
            <div className="project-detail-outer">
              <div className="project-detail-containt">
                <div className=" text-black">
                  <h3 style={{color:'#B19777'}}>Making Your Child’s Life More Practical with Smart Wardrobe Solutions</h3>
                  ...
                  <p style={{color:'#fff'}}>From playful colors and creative patterns to sleek modern designs, we offer a wide range of sliding wardrobes to match your child’s personality and room décor. Whether you prefer built-in or freestanding options, every wardrobe is crafted to fit seamlessly into your child’s space. More than just storage, these wardrobes encourage organization, making it easier for kids to keep their room tidy.</p>
                  <h3 style={{color:'#B19777'}}>Encouraging Organization with Fun & Functional Designs</h3>
                  <p style={{color:'#fff'}}>Keeping a child’s bedroom tidy can be a challenge, but the right storage solutions make all the difference. Instead of constantly reminding them to clean up, provide them with a well-designed sliding wardrobe that makes organization effortless. With dedicated spaces for their belongings, kids learn the habit of placing items back in their designated spots, creating a clutter-free and stress-free environment.</p>
                  <p style={{color:'#fff'}}>Our collection includes mirror sliding wardrobes, 2-door, 3-door, and 4-door options, as well as glossy and custom-themed designs. Whether your child’s room follows a fun theme or a minimalist style, <b style={{color:'#B19777'}}>CraftMySpace</b> offers tailor-made sliding wardrobes that blend practicality with creativity—ensuring both you and your child love the space they live in.</p>
                 
                 
                </div>
                <div className=" text-black">
                  <h3 style={{color:'#B19777'}}>Children’s Fitted Wardrobes</h3>
                 ...
                 <p style={{color:'#fff'}}>From vibrant colors and playful designs to sleek modern finishes, our fitted wardrobes seamlessly blend with any décor. Whether you prefer built-in or freestanding options, every wardrobe is crafted to maximize space while making organization fun and effortless for your child. <b style={{color:'#B19777'}}>CraftMySpace</b> brings you the perfect balance of practicality and creativity in children's storage solutions.</p>
