...
//                       pieces of wood together without the use of nails or screws
//                       in traditional methods. It involves skilled techniques
//                       such as mortise and tenon, dovetail, and tongue-and-groove
//                       joints to create durable and aesthetically pleasing
//                       woodwork.
//                     </p>
//                     <p>
//                       Joinery is the art and craft of working with wood to
//                       create structures, furniture, and decorative elements
//                       through precise joining techniques. It involves cutting,
//                       shaping, and assembling wood pieces to produce durable and
//                       aesthetically appealing products. Unlike carpentry, which
//                       focuses on broader construction tasks, joinery specializes
//                       in intricate details such as doors, windows, staircases,
//                       and cabinetry.
//                     </p>
//                   </div>
...
//                     tailored to your needs. Our skilled craftsmen, trained in
//                     leading European techniques, transform premium-quality wood
//                     into elegant furniture, custom doors, decorative wall and
//                     ceiling panels, arches, columns, beams, and staircases.
//                     Whether for residential or commercial spaces, we ensure
//                     every piece reflects exceptional craftsmanship, durability,
//                     and timeless aesthetics, elevating interiors with bespoke
//                     joinery solutions
//                   </p>
//                 </div>
//                 <div className="masonry-item cat-1 col-lg-4 col-md-6 col-sm-12 m-b30">
//                   <div className="project-img-effect-1">
//                     <img src="/assets/pic/joinery1.jpg" alt="" />
...
//                   <div className="project-img-effect-1">
//                     <img src="/assets/pic/joinery2.jpg" alt="" />
//                     <div className="wt-info">
//                       <h4 className="wt-tilte text-white  m-b10 m-t0">
//                         Bespoke Kitchens
//                       </h4>
...
//                   <div className="project-img-effect-1">
//                     <img src="/assets/pic/joinery3.jpg" alt="" />
//                     <div className="wt-info">
//                       <h4 className="wt-tilte text-white  m-b10 m-t0">
//                         Wooden Furniture
//                       </h4>
...
//                   <div className="project-img-effect-1">
//                     <img src="/assets/pic/joinery4.jpg" alt="" />
//                     <div className="wt-info">
//                       <h4 className="wt-tilte text-white  m-b10 m-t0">
//                         Walk in Wardrobes
//                       </h4>
...
//                   <div className="project-img-effect-1">
//                     <img src="/assets/pic/joinery5.jpg" alt="" />
//                     <div className="wt-info">
//                       <h4 className="wt-tilte text-white  m-b10 m-t0">
//                         Wooden Windows
//                       </h4>
...
//                   <div className="project-img-effect-1">
//                     <img src="/assets/pic/joinery6.jpg" alt="" />
//                     <div className="wt-info">
//                       <h4 className="wt-tilte text-white  m-b10 m-t0">
//                         Wall Panels
//                       </h4>
...
//                       woodwork of the highest quality. From custom doors,
//                       windows, and staircases to elegant furniture and
...
//                           designed doors, and the creation of bespoke furniture,
//                           staircases, and other interior and exterior wood
//                           elements. By maintaining full control over production,
//                           we ensure exceptional quality, seamless customization,
//                           and the perfect blend of aesthetics and durability.
//                         </p>
//                       </div>
//                       <ul>
...
//                           </h4>
//                           <p>
//                             Utilizing state-of-the-art Italian woodworking
//                             equipment, a team of over 100 skilled carpenters,
//                             and advanced automation, we ensure unmatched
...
//                           </h4>
//                           <p>
//                             Our premium craftsmanship is achieved through
//                             meticulous material selection, precise preparation,
...
//                             project to life with perfection and ease.
//                           </p>
//                         </li>
//                       </ul>
//                     </div>
...
//           {/* faq start */}
//           <section
//             className="faqs section-padding position-re"
//             style={{ padding: "140px 0px" ,borderBottom:'2px solid #B19777'}}
//           >
//             <div className="container">
...
//                           background: openIndex === index ? "#B19777" : "#000",
//                           boxShadow:
//                             openIndex === index
...
//           <div className="section-full p-t80 p-b80  overflow-hide home-2-about-outer">
//             <div className="container">
//               <div className="section-content">
//                 <div className="row">
...
//                             Architecture who try to Ambitions people do that
//                             really{" "}
//                           </p>
//                           <a
//                             href=""
...
//                             <div className="wt-thum-bx">
//                               <img
//                                 src="/assets/pic/bathroom-design (2).jpg"
//                                 alt=""
//                               />
//                             </div>
//                           </div>
  ...
  return (
    ...
    <div>
        ...
        <div class="col-6 col-md-3 mb-4">
          ...
          {/* <!-- WELCOME SECTION START --> */}
          <motion.div className="section-full p-t80 p-b80  overflow-hide home-2-about-outer">
            <div className="container">
              <div className="section-content">
                <div className="row">
                  <div className="col-xl-5  col-lg-6 col-md-12">
