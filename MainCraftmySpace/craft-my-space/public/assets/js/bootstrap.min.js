...
const TW_box = document.getElementById('TW_box');
const Cookie_btn = document.getElementById('Cookie_btn');

Cookie_btn.onclick = function () {
  // Set cookie
  document.cookie = "CookieConsentByFineshop=Accepted; max-age=2592000; path=/";

  // Add hide class to animate out
  TW_box.classList.add('hide');

  // Remove from DOM after animation
  setTimeout(() => {
    TW_box.style.display = 'none';
  }, 600);
};

// Check if cookie already accepted
if (document.cookie.includes("CookieConsentByFineshop=Accepted")) {
  TW_box.style.display = 'none';
}